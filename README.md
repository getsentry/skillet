...
For an existing skill, run `skillet status <path>`. Uppercase `SPEC.md` is treated as legacy input; preserve or rename it, then derive lowercase `spec.md` before adding eval coverage.
