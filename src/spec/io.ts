 ...
 * whitespace. The banner declares CLI ownership: any user reading the
 * file sees that direct edits are unsupported.
 *
 ...
 * is ever updated — the next write picks up the new wording. We never
 * lose user content because the spec content lives below the banner
 * in structured YAML, not in the banner.
 */
...
# (any \`skillet spec\`, \`add-eval\`, \`improve\`, or \`create\`).
# ──────────────────────────────────────────────────────────
`;
