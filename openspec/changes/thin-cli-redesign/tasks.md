...
- [x] 7.2 Dogfood: recreate one real skill (e.g. the commit skill) end-to-end via `/skillet:propose` → `/skillet:render` → `skillet eval --trials 3 --baseline` and record the lift numbers
