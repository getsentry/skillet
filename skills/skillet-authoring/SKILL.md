...
3. When `spec.md` is next, fetch `skillet instructions spec <dir> --json`, resolve ambiguous intent with 2–4 pointed questions, write the spec, then run `skillet validate <dir>` and fix every spec error before deriving anything.
